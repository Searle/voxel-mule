...
//
     ...
     //   console.log(window.devicePixelRatio);
      ...
      //  this.renderer.setClearColor(0xFFA1C1, 1);
        ...
        this.modelLoader.loadFiles(this._modelsLoaded.bind(this));
    }

    Main.prototype._modelsLoaded= function() {

//        var ambient_light = new THREE.AmbientLight( 0xFFFFFF, 0.8);
//        game.scene.add( ambient_light );
...
/*
        ...
        for ( var y= -100; y < 100; y++ ) {
            for ( var x= -100; x < 100; x++ ) {
                this.world.addBlock(x,y,z, 128,128,128);
            }
        }
*/
...
///        this.particles_box.init(1000, 1);
    ...
    Main.prototype.waitForLoadMap = function() {
        ...
        this.objects["mule1"] = new Mule();
        this.objects["mule1"].create();
